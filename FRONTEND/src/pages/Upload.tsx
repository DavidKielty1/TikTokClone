          ...
          <div className="mt-8 md:flex gap-6">
            {!fileDisplay ? (
              ...
              >
                ...
                <div className="mt-2 text-gray-400 text0[13px]">
                  Less than 2 GB
                </div>
                <div className="px-2 py-1.5 mt-8 text-white text-[15px] w-80% bg-pinkred rounded-sm">
                  Select a File
                </div>
                <input
                  type="file"
              ...
              <>
                <div className="md:mx-0 mx-auto mt-4 md:mb-12 mb-16 flex items-center justify-center w-full max-w-[260px] h-[540px] p-3 rounded-2xl cursor-pointer relative">
                  <div className="bg-black h-full w-full">
                    <img
                      className="absolute z-20 right-0 -bottom-1 pointer-events-none"
                      src="src/assets/images/mobile-case.png"
                    />
                    <img
                      className="absolute right-0.5 bottom-6 z-20"
                      width="90"
                    ...
                    <video
                      ...
                      src={fileDisplay}
                    ></video>
                    <div className="absolute right-0 -bottom-12 flex items-center justify-between border-gray-300 w-full p-2 border rounded-xl z-50  ">
                ...
                <div className="mt-4 mb-6">
                  <div className="flex bg-[#F8F8F8] py-4 px-6">
                    ...
                    <div className="flex justify-end max-w-[130px] w-full h-full text-center my-auto">
                      <button className="px-8 py-1.5 text-white text-[15px] bg-pinkred rounded-sm">
                        Edit
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="px-10 py-2.5 mt-8 border text-[16px] text-white bg-pinkred rounded-sm"
                    >
                      Post
                    </button>
                  </div>
